...
public class ABCMysqlToRabbitMq2 {
    public static void main(String[] args) throws Exception {
        ...
        MySqlSource actAbcsuzhou = MySqlSource.<String>builder()
                ...
                .tableList( "act_abcsuzhou.t_poster_account") // set captured table
                .username("canal")
                .password("YlX8ndVFJQV51JKl")
                .includeSchemaChanges(false)
                .startupOptions(StartupOptions.initial())
                .deserializer(new ABCMySqlBinlogSourceJson2()) // converts SourceRecord to JSON String
...
class ABCMySqlBinlogSourceJson2 implements DebeziumDeserializationSchema {
    @Override
