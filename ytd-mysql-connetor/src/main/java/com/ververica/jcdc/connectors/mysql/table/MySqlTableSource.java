...
package com.ververica.jcdc.connectors.mysql.table;

import com.ververica.cdc.connectors.mysql.source.MySqlSourceBuilder;
import com.ververica.jcdc.connectors.mysql.source.MySqlSource;
        ...
        if (enableParallelRead) {
            ...
            MySqlSource<RowData> parallelSource =
                    MySqlSource.<RowData>builder()
                            ...
                            .build();
//            return SourceFunctionProvider.of((SourceFunction<RowData>) parallelSource, true);
