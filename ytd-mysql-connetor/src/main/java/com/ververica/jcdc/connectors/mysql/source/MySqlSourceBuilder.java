...
package com.ververica.jcdc.connectors.mysql.source;
...
/**
 * The builder class for {@link com.ververica.cdc.connectors.mysql.source.MySqlSource} to make it easier for the users to construct a {@link
 ...
 * {@link com.ververica.cdc.connectors.mysql.source.MySqlSource}.
 */
@PublicEvolving
public class MySqlSourceBuilder<T> {
    ...
    /** Whether the {@link com.ververica.cdc.connectors.mysql.source.MySqlSource} should output the schema changes or not. */
    ...
    /** Whether the {@link com.ververica.cdc.connectors.mysql.source.MySqlSource} should scan the newly added tables or not. */
    ...
    /**
     * Build the {@link com.ververica.cdc.connectors.mysql.source.MySqlSource}.
     *
